        ...
        <section className={"l-contact"}>
            ...
            <div className={"l-contact__m-flexDiv"}>
                <div className={"l-contact__m-infoDiv"}>
                    ...
                    <br />
                    <TextDefault>
                        <strong className={"l-contact__m-infoDiv--a-span"}>Availability</strong> <br />Currently finishing my Master degree until September 2024 on Paris but after that I will be available to work anywhere. I was used to travel a lot where studying in engineering school so distance isn't a problem.
                    </TextDefault>
                    {statusAOS && (
                        <Email

    ...
    return (
      <Html>
        <Head>
          ...
          <meta name="p:domain_verify" content="79a0b9a84f1fabea9b167a6b36303154"/>
          <script type={"text/javascript"} defer src={"https://code.jquery.com/jquery-3.5.1.min.js"}></script>

          <link rel="stylesheet"
                href="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/11.6.0/styles/felipec.min.css"/>

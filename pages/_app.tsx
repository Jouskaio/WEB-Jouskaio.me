    ...
    return (
      <main className={"l-main"}>
          ...
          <div className={"l-main__o-paramsDiv"}>
              {sizeAOS && (
                  <>
                      <button className={"l-main__a-moreMenu"} data-aos={size && size.width <= 768 ? "fade-down" : "fade-left"} data-aos-duration={1000}><Image src="/icons/more.svg" alt="More" height={"16px"} width={"16px"}/></button>
                      <button className={"l-main__a-param"} data-aos={size && size.width <= 768 ? "fade-down" : "fade-left"} data-aos-duration={1200}><Image src={"/icons/params.svg"} alt={"Param"} height={"16px"} width={"16px"}/></button>
                  </>
              )}
          </div>
